...
export const RubyMineIcon = ({ size = 32 }: Props) => {
  return (
    <svg fill="none" viewBox="0 0 64 64" width={size} height={size}>
      <defs>
        <linearGradient
          id="__JETBRAINS_COM__LOGO_PREFIX__18"
          x1="4.325"
          x2="62.921"
          y1="59.932"
          y2="1.337"
        ...
        >
          <stop offset="0.29" stopColor="#FF2358"></stop>
          <stop offset="0.75" stopColor="#7256FF"></stop>
        </linearGradient>
        <linearGradient
          id="__JETBRAINS_COM__LOGO_PREFIX__17"
          x1="-0.391"
          x2="24.393"
          y1="7.671"
          y2="61.125"
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0.29" stopColor="#FF8100"></stop>
          <stop offset="0.56" stopColor="#FF2358"></stop>
        </linearGradient>
      </defs>
      <path
        fill="url(#__JETBRAINS_COM__LOGO_PREFIX__18)"
        d="M59.875 0H25.748a4.125 4.125 0 0 0-3.8 2.52L6.151 39.942a4.118 4.118 0 0 0-.325 1.639l.15 18.328A4.125 4.125 0 0 0 10.101 64h17.666a4.12 4.12 0 0 0 2.266-.678l32.109-21.108A4.123 4.123 0 0 0 64 38.766V4.125A4.125 4.125 0 0 0 59.875 0Z"
      ></path>
      <path
        fill="url(#__JETBRAINS_COM__LOGO_PREFIX__17)"
        d="M14.987 6H4.126A4.125 4.125 0 0 0 0 10.125v12.566c0 .2.014.4.044.598l5.448 37.184A4.125 4.125 0 0 0 9.572 64H24.97a4.125 4.125 0 0 0 4.125-4.126l-.004-18.504c0-.426-.067-.85-.196-1.254L18.916 8.87A4.126 4.126 0 0 0 14.987 6Z"
      ></path>
      <path
        fill="#FF8100"
