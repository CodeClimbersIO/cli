...
export const PhpStormIcon = ({ size = 32 }: Props) => {
  return (
    <svg fill="none" viewBox="0 0 64 64" width={size} height={size}>
      <defs>
        ...
        >
          <stop offset="0.16" stopColor="#D249FC"></stop>
          <stop offset="0.55" stopColor="#FF2D90"></stop>
        </linearGradient>
        <linearGradient
        ...
        >
          ...
          <stop offset="0.7" stopColor="#7256FF"></stop>
        </linearGradient>
      </defs>
      <path
        fill="#D249FC"
        d="M58 16.446V4.187A4.125 4.125 0 0 0 53.81.063L42.765.239A4.125 4.125 0 0 0 39.7 1.68L6.993 39.837A4.13 4.13 0 0 0 6 42.522v11.35a4.125 4.125 0 0 0 4.125 4.124h11.003c1.19 0 2.321-.514 3.104-1.409L56.98 19.162A4.124 4.124 0 0 0 58 16.446Z"
      ></path>
      <path
