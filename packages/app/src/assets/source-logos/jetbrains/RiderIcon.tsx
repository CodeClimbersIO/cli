...
export const RiderIcon = ({ size = 32 }: Props) => {
  return (
    <svg fill="none" viewBox="0 0 64 64" width={size} height={size}>
      <defs>
        <linearGradient
          id="__JETBRAINS_COM__LOGO_PREFIX__10"
          x1="64.391"
          x2="39.607"
          y1="56.329"
          y2="2.874"
        ...
        >
          <stop offset="0.21" stopColor="#007DFE"></stop>
          <stop offset="0.55" stopColor="#FFB700"></stop>
        </linearGradient>
        <linearGradient
          id="__JETBRAINS_COM__LOGO_PREFIX__9"
          x1="59.676"
          x2="1.08"
          y1="4.067"
          y2="62.663"
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0.23" stopColor="#FFB700"></stop>
          <stop offset="0.73" stopColor="#FF0A67"></stop>
        </linearGradient>
      </defs>
      <path
        fill="#007DFE"
      ...
      ></path>
      <path
        fill="url(#__JETBRAINS_COM__LOGO_PREFIX__10)"
      ...
      ></path>
      <path
        fill="url(#__JETBRAINS_COM__LOGO_PREFIX__9)"
        d="M4.125 64h34.127a4.125 4.125 0 0 0 3.8-2.52L57.85 24.057c.219-.518.33-1.076.324-1.638l-.15-18.329A4.124 4.124 0 0 0 53.9 0H36.234a4.13 4.13 0 0 0-2.266.678L1.86 21.787A4.125 4.125 0 0 0 0 25.234v34.641A4.125 4.125 0 0 0 4.125 64Z"
      ></path>
