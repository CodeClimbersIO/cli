...
export const GoLandIcon = ({ size = 32 }: Props) => {
  return (
    <svg fill="none" viewBox="0 0 64 64" width={size} height={size}>
      <defs>
        ...
        >
          <stop offset="0.24" stopColor="#00D886"></stop>
          <stop offset="0.51" stopColor="#007DFE"></stop>
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset="0.27" stopColor="#007DFE"></stop>
          <stop offset="0.7" stopColor="#D249FC"></stop>
        </linearGradient>
      </defs>
      <path
        fill="#00D886"
